...
class OrderProcessor
{
    ...
    public function checkAndTransition(AcmeOrder $order): AcmeOrder
    {
        ...
        if ($anyInvalid) {
            ...
            CaLog::acmeOperation('order_status_changed', ['order_id' => $order->id, 'status' => 'invalid']);
        ...
        if ($allValid) {
            ...
            CaLog::acmeOperation('order_status_changed', ['order_id' => $order->id, 'status' => 'ready']);
    ...
    public function processChallenge(\CA\Acme\Models\AcmeChallenge $challenge): void
    {
        ...
        CaLog::acmeOperation('authorization_validated', ['authorization_id' => $authorization->id]);
    ...
    public function expireOrders(): int
    {
        return DB::transaction(function (): int {
            ...
            CaLog::acmeOperation('orders_expired', ['count' => $expiredOrders->count()]);
