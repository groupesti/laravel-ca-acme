...
class AcmeServer implements AcmeServerInterface
{
    ...
    public function newAccount(array $payload, string $jwk): AcmeAccount
    {
        ...
        if ($existing !== null) {
            CaLog::acmeOperation('account_retrieved', ['thumbprint' => $thumbprint]);
        ...
        CaLog::acmeOperation('account_created', [
    ...
    public function newOrder(AcmeAccount $account, array $identifiers): AcmeOrder
    {
        ...
        CaLog::acmeOperation('order_created', [
            'order_id' => $order->id,
            'account_id' => $account->id,
            'identifiers' => $identifiers,
        ]);
    ...
    public function finalizeOrder(AcmeOrder $order, string $csr): AcmeOrder
    {
        ...
        try {
            ...
            CaLog::acmeOperation('order_finalized', [
                'order_id' => $order->id,
                'certificate_id' => $certificate->id,
            ]);
            ...
            CaLog::critical($e->getMessage(), ['operation' => 'acme_operation', 'exception' => $e::class, 'order_id' => $order->id]);
    ...
    public function getCertificate(AcmeOrder $order): string
    {
        ...
        CaLog::acmeOperation('certificate_downloaded', [
            'order_id' => $order->id,
    ...
    public function revokeCertificate(string $certPem, ?int $reason = null): void
    {
        ...
        CaLog::acmeOperation('certificate_revoked', [
            'certificate_id' => $certificate->id,
